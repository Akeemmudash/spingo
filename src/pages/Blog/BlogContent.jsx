...
export default function BlogPost() {
  ...
  return (
    <div className="blogpost-container">
      ...
      <div><BsPersonCircle /> {blog.author}</div>
      <div>
      ...
      <div className="dblogPost">
        ...
        <div className="lastRead">
          ...
          <p>
            ...
            standards. In addition to quality, Vescan places a strong emphasis
            on customer support. A dedicated team is available to assist users
            with any queries or issues, ensuring that the platform operates
            smoothly and that users have the support they need to make informed
            purchasing decisions. In a rapidly evolving industry, Vescan’s
            innovative platform stands out as a game-changer, providing
            mechanics and towing companies with the tools they need to succeed
            in an increasingly competitive market. By revolutionizing the way
            spare parts are sourced and ordered, Vescan is setting a new
            standard for efficiency, reliability, and customer satisfaction in
            automotive repair.
          </p>
        </div>
      </div>
